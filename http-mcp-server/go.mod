module 2025-hack-mcp-server-mcp-golang

go 1.24.1

require (
	github.com/happyreturns/data-castle/modules/returns-service v0.20.1
	github.com/happyreturns/gohelpers v1.46.1
...
require (
	...
	github.com/happyreturns/go-jwt-middleware v1.0.1 // indirect
